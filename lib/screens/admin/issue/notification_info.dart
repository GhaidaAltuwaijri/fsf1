...
class notificationInfo extends StatefulWidget {
  ...
  final Issue issue;
  const notificationInfo({this.issue, Key key, @required this.onBackPress}) : super(key: key);
                              ...
                              Column(
                                  children: [
                                    IconButton(
                                      ...
                                      iconSize: 60,
                                      onPressed: () async {
                                        Place place = await Place.getPlaceInfo(widget.issue.placeId);
                                        ...
                                        children: [
                                          IconButton(
                                            ...
                                            onPressed: () async {
                                              ...
                                              var collection2 = FirebaseFirestore.instance.collection('Notifications').doc(widget.issue.reportId);
                                  ...
                                  children: [
                                    IconButton(
                                      ...
                                      onPressed: () async {
                                        ...
                                        Fluttertoast.showToast(
                                          msg: "Notification resolved successfully",
                                          toastLength: Toast.LENGTH_LONG,
                                        );
                                        Navigator.of(context).pop();
                                      },
