...
class ChatbotPlaceInfo extends StatefulWidget {
  final isFav;
  final Place place;
  final Geometry geo;

  ChatbotPlaceInfo({this.place, @required this.isFav, @required this.geo});

  @override
  State<ChatbotPlaceInfo> createState() => _ChatbotPlaceInfoState();
}

class _ChatbotPlaceInfoState extends State<ChatbotPlaceInfo> {
